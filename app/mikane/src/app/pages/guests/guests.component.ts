...
export class GuestsComponent {
	...
	constructor(private userService: UserService, private messageService: MessageService, protected breakpointService: BreakpointService, public dialog: MatDialog) {}
